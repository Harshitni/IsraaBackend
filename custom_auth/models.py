...
class AuthUsers(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['phone'], name='users_phone_key'),
        ...
        indexes = [
            models.Index(fields=['instance_id'], name='users_instance_id_idx'),
            models.Index(fields=['is_anonymous'], name='users_is_anonymous_idx'),
        ]

    def __str__(self):
        return f"Auth.User(id={self.id}, email={self.email}, role={self.role}, is_super_admin={self.is_super_admin})"
