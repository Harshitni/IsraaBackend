# Generated by Django 4.2.11 on 2025-07-08 08:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(default=datetime.datetime(2025, 7, 15, 8, 27, 34, 151663, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='verse_bookmarks', to='custom_auth.authusers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(null=True)),
                ('updated_at', models.DateTimeField(null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_reading_stats', to='custom_auth.authusers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(null=True)),
                ('updated_at', models.DateTimeField(null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profile_community', to='custom_auth.authusers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id_fkey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='custom_auth.authusers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_prompt', models.TextField(blank=True, null=True)),
                ('knowledge_base', models.TextField(blank=True, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preferences', to='custom_auth.authusers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prayer_summaries', to='custom_auth.authusers')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user_fkey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscriber', to='custom_auth.authusers'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quran_progress', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='pushsubscription',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='push_subscriptions', to='custom_auth.authusers'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['requester_id'], name='idx_prayer_pal_connection_req'),
        ),
        migrations.AddIndex(
            model_name='prayerpalconnection',
            index=models.Index(fields=['receiver_id'], name='idx_prayer_pal_connection_rec'),
        ),
        migrations.AddConstraint(
            model_name='prayerpalconnection',
        ...
        migrations.AddIndex(
            model_name='palmessage',
            index=models.Index(fields=['connection_id', 'created_at'], name='idx_pal_messages_connection_id'),
        ),
        migrations.AddIndex(
            model_name='palmessage',
            index=models.Index(fields=['sender_id', 'receiver_id', 'created_at'], name='idx_pal_messages_participants'),
        ),
        migrations.AddField(
            model_name='notificationschedule',
            name='user_id',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, to='custom_auth.authusers'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(db_column='created_by', on_delete=django.db.models.deletion.CASCADE, to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='groupjoinrequest',
            name='group_id',
            field=models.ForeignKey(db_column='group_id', on_delete=django.db.models.deletion.CASCADE, related_name='group_join_requests', to='public.accountabilitygroup'),
        ),
        migrations.AddField(
            model_name='groupjoinrequest',
            name='reviewed_by',
            field=models.ForeignKey(blank=True, db_column='reviewed_by', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviewed_group_requests', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='groupjoinrequest',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_joining_user', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='groupchatparticipant',
            name='group_id',
            field=models.ForeignKey(db_column='group_id', on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='public.accountabilitygroup'),
        ),
        migrations.AddField(
            model_name='groupchatmessage',
            name='group_id',
            field=models.ForeignKey(db_column='group_id', on_delete=django.db.models.deletion.CASCADE, related_name='group_chat_messages', to='public.accountabilitygroup'),
        ),
        migrations.AddField(
            model_name='groupchatmessage',
            name='replied_to_message',
            field=models.ForeignKey(blank=True, db_column='replied_to_message_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='replies', to='public.groupchatmessage'),
        ),
        migrations.AddField(
            model_name='freetrial',
            name='activated_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activated_trial', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='freetrial',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='free_trial', to='custom_auth.authusers'),
        ),
        migrations.AddIndex(
            model_name='emotionaltracking',
            index=models.Index(fields=['user_id'], name='idx_eml_trk_usr_id'),
        ),
        migrations.AddIndex(
            model_name='emotionaltracking',
            index=models.Index(fields=['created_at'], name='idx_eml_trk_ctd_at'),
        ),
        migrations.AddField(
            model_name='duafavorite',
            name='user_id',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='dua_favorites', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='discountcode',
            name='created_by',
            field=models.ForeignKey(db_column='created_by', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='discount_codes_created', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='communityreaction',
            name='comment_id',
            field=models.ForeignKey(blank=True, db_column='comment_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reactions', to='public.communitycomment'),
        ),
        migrations.AddField(
            model_name='communityreaction',
            name='post_id',
            field=models.ForeignKey(blank=True, db_column='post_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reactions', to='public.communitypost'),
        ),
        migrations.AddField(
            model_name='communityreaction',
            name='user_id',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='community_reactions', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='communitypost',
            name='category_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='public.postcategory'),
        ),
        migrations.AddField(
            model_name='communitypost',
        ...
        migrations.AddField(
            model_name='communitypost',
            name='user_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='community_posts', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='communityjoinrequest',
            name='reviewed_by',
            field=models.ForeignKey(blank=True, db_column='reviewed_by', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviewed_requests', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='communityjoinrequest',
            name='user_id',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='join_requests', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='communitycomment',
            name='post',
            field=models.ForeignKey(db_column='post_id', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='public.communitypost'),
        ),
        migrations.AddField(
            model_name='communitycomment',
            name='user',
            field=models.ForeignKey(db_column='user_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_comments', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='communitycomment',
            name='user_profile',
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='chat_messages', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='challengegroupmember',
            name='user',
            field=models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='challenge_group_memberships', to='custom_auth.authusers'),
        ),
        migrations.AddIndex(
            model_name='cachemetadata',
            index=models.Index(fields=['cache_type'], name='idx_cache_metadata_type'),
        ),
        migrations.AddIndex(
            model_name='cachedreciter',
            index=models.Index(fields=['name'], name='idx_cached_reciters_name'),
        ),
        migrations.AddIndex(
            model_name='cachedchapters',
            index=models.Index(fields=['name_simple'], name='idx_cached_chapters_name'),
        ),
        migrations.AddField(
            model_name='adminaction',
            name='admin_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin_actions', to='custom_auth.authusers'),
        ),
        migrations.AddField(
            model_name='adminaction',
            name='target_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='target_admin_actions', to='custom_auth.authusers'),
        ),
        migrations.AddField(
